...
if ($bookingdatefrom < $today || $bookingdateto < $today) {
  echo "<script>alert('Booking dates cannot be in the past.');</script>";
} elseif ($bookingdatefrom > $bookingdateto) {
  echo "<script>alert('Booking start date cannot be after the end date.');</script>";
} 
  // Check availability
...
//Code for Insertion
$query=mysqli_query($con,"insert into tblbookings(BoatID,BookingNumber,FullName,EmailId,PhoneNumber,BookingDateFrom,BookingDateTo,BookingTime,NumnerofPeople,Notes) 
values('$boatid','$bno','$fname','$emailid','$phonenumber','$bookingdatefrom','$bookingdateto','$bookingtime','$nopeople','$notes')");
if($query){
          ...
          <div class="col-md-6">
            ...
            <form action="#" class="row" method="post">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="fname" pattern="[A-Z][a-zA-Z\s]*" title="First latter should be capital,only latters and space allowed" required="true">
              </div>
              <div class="form-group col-md-6">
                <label for="input-2">Number of People:</label>
                <input type="text" class="form-control" min="1" name="nopeople" required="true">
              </div>
             ...
             <div class="form-group col-md-6">
                <label for="input-5">Time:</label>
                <input type="time" class="form-control timepicker" name="bookingtime" min="04:00" max="20:00" required="true">
              </div>
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="phonenumber" maxlength="10" pattern="[0-9]{10}" title="only numbers are allowed" required="true"> 
              </div>
